...
const OxygenPulsePage = () => {
          ...
          if (topic === "kiosk/sensor/oxygen") {
            ...
            if (!hasReceivedData.current) {
              try {
                ...
                if (data.oxygen !== undefined && data.bpm !== undefined) {
  ...
  useEffect(() => {
    ...
    if (measurementState === "measuring" && countdown > 0) {
      ...
      // Safety timeout at 60 seconds
      if (import.meta.env.DEV) console.log("⏱️ Measurement timeout reached");
      setMeasurementState("error");
      setStatusMessage("Safety timeout (60s) - Sensor not responding");
