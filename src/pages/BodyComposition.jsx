...
const BodyComposition = () => {
  ...
  // ─── RENDER ──────────────────────────────────────────────────
  return (
    <div className="relative w-full h-[100dvh] min-h-screen bg-gradient-to-br from-[#FFEEE5] via-[#FFF5F0] to-[#FFE8DC] overflow-x-hidden overflow-y-auto scrollable-container font-sans flex flex-col">
      {/* Back button */}
