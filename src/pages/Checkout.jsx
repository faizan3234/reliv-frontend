...
export default function Checkout() {
  ...
  if (cart.length === 0 && !fromPaymentGate) {
    return (
      <div className="min-h-screen w-full bg-slate-50 flex flex-col items-center justify-center font-sans p-4 overflow-y-auto scrollable-container touch-pan-y select-none">
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 flex flex-col font-sans overflow-y-auto scrollable-container touch-pan-y select-none pb-36">
      {/* BACK BUTTON */}
      <button
        onClick={() => navigate(-1)}
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="w-20 h-20 bg-gray-100 flex items-center justify-center flex-shrink-0">
                    {getMedicineImageUrl(item) ? (
                      <img src={getMedicineImageUrl(item)} alt={item.name} className="w-full h-full object-cover" />
                    ) : (
                        ...
                        <div className="flex gap-4 mb-4">
                          <div className="w-16 h-16 bg-gray-100 flex-shrink-0 flex items-center justify-center">
                            {getMedicineImageUrl(kit) ? (
                              <img src={getMedicineImageUrl(kit)} alt={kit.name} className="w-full h-full object-cover" />
                            ) : (
