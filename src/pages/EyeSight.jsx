...
export default function EyeSight() {
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .vision-footer{margin-top:24px;text-align:center;font-size:11px;color:#a8a29e;font-weight:500;letter-spacing:0.5px;padding-bottom:8px}
    `;
  ...
  const checkAnswer = () => {
    if (userInput.toUpperCase() === answer) {
      ...
      setTimeout(() => navigate("/body-composition"), 2000);
    } else {
